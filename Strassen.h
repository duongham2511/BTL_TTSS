...
void matMul_Strassen_P_body(T**& A, T**& B, T**& C, int size)
{
    ...
    } else 
    {
        ...
        #pragma omp task
        {
            MatOp::AddMat<T>(A_11,A_22,T_1,size/2);
            MatOp::AddMat<T>(B_11,B_22,T_6,size/2);
...
template <typename T>
void matMul_Strassen_P2(T**& A, T**& B, T**& C, int size)
{
    if (size <= THRESHOLD)
    {
        MatOp_P::matMul_Naive<T>(A, B, C, size,size,size);
    } else 
    {
        ...
        MatOp_P::split2D<T>(A,A_11,size/2,0,0);
        MatOp_P::split2D<T>(A,A_12,size/2,0,size/2);
        MatOp_P::split2D<T>(A,A_21,size/2,size/2,0);
        MatOp_P::split2D<T>(A,A_22,size/2,size/2,size/2);
        MatOp_P::split2D<T>(B,B_11,size/2,0,0);
        MatOp_P::split2D<T>(B,B_12,size/2,0,size/2);
        MatOp_P::split2D<T>(B,B_21,size/2,size/2,0);
        MatOp_P::split2D<T>(B,B_22,size/2,size/2,size/2);

        MatOp_P::AddMat<T>(A_11,A_22,T_1,size/2);
        MatOp_P::AddMat<T>(B_11,B_22,T_6,size/2);
        matMul_Strassen_P2<T>(T_1,T_6,Q_1,size/2);

        MatOp_P::AddMat<T>(A_21,A_22,T_2,size/2);
        matMul_Strassen_P2<T>(T_2,B_11,Q_2,size/2);

        MatOp_P::SubMat<T>(B_12,B_22,T_7,size/2);
        matMul_Strassen_P2<T>(A_11,T_7,Q_3,size/2);

        MatOp_P::SubMat<T>(B_21,B_11,T_8,size/2);
        matMul_Strassen_P2<T>(A_22,T_8,Q_4,size/2);

        MatOp_P::AddMat<T>(A_11,A_12,T_3,size/2);
        matMul_Strassen_P2<T>(T_3,B_22,Q_5,size/2);

        MatOp_P::SubMat<T>(A_21,A_11,T_4,size/2);
        MatOp_P::AddMat<T>(B_11,B_12,T_9,size/2);
        matMul_Strassen_P2<T>(T_4,T_9,Q_6,size/2);

        MatOp_P::SubMat<T>(A_12,A_22,T_5,size/2);
        MatOp_P::AddMat<T>(B_11,B_22,T_10,size/2);
        matMul_Strassen_P2<T>(T_5,T_10,Q_7,size/2);
        ...
        MatOp_P::AddMat<T>(Q_1,Q_4,U_1,size/2);
        MatOp_P::SubMat<T>(Q_5,Q_7,U_2,size/2);
        MatOp_P::AddMat<T>(Q_3,Q_1,U_3,size/2);
        MatOp_P::SubMat<T>(Q_2,Q_6,U_4,size/2);
        ...
        MatOp_P::SubMat<T>(U_1,U_2,C_11,size/2);
        MatOp_P::AddMat<T>(Q_3,Q_5,C_12,size/2);
        MatOp_P::AddMat<T>(Q_2,Q_4,C_21,size/2);
        MatOp_P::SubMat<T>(U_3,U_4,C_22,size/2);
        ...
        MatOp_P::join2D<T>(C_11,C,size/2,0,0);
        MatOp_P::join2D<T>(C_12,C,size/2,0,size/2);
        MatOp_P::join2D<T>(C_21,C,size/2,size/2,0);
        MatOp_P::join2D<T>(C_22,C,size/2,size/2,size/2);
...
template <typename T>
void matMul_Strassen_P3_body(T**& A, T**& B, T**& C, int size)
{
    if (size <= THRESHOLD)
    {
        MatOp_P::matMul_Naive<T>(A, B, C, size,size,size);
    } else 
    {
        ...
        #pragma omp task
        {
            MatOp_P::AddMat<T>(A_11,A_22,T_1,size/2);
            MatOp_P::AddMat<T>(B_11,B_22,T_6,size/2);
            matMul_Strassen_P3_body<T>(T_1,T_6,Q_1,size/2);
        }

        #pragma omp task
        {
        MatOp_P::AddMat<T>(A_21,A_22,T_2,size/2);
        matMul_Strassen_P3_body<T>(T_2,B_11,Q_2,size/2);
        }

        #pragma omp task
        {
        MatOp_P::SubMat<T>(B_12,B_22,T_7,size/2);
        matMul_Strassen_P3_body<T>(A_11,T_7,Q_3,size/2);
        }

        #pragma omp task
        {
        MatOp_P::SubMat<T>(B_21,B_11,T_8,size/2);
        matMul_Strassen_P3_body<T>(A_22,T_8,Q_4,size/2);
        }

        #pragma omp task
        {
        MatOp_P::AddMat<T>(A_11,A_12,T_3,size/2);
        matMul_Strassen_P3_body<T>(T_3,B_22,Q_5,size/2);
        }
        ...
        MatOp_P::SubMat<T>(A_21,A_11,T_4,size/2);
        MatOp_P::AddMat<T>(B_11,B_12,T_9,size/2);
        matMul_Strassen_P3_body<T>(T_4,T_9,Q_6,size/2);
        }
        ...
        MatOp_P::SubMat<T>(A_12,A_22,T_5,size/2);
        MatOp_P::AddMat<T>(B_11,B_22,T_10,size/2);
        matMul_Strassen_P3_body<T>(T_5,T_10,Q_7,size/2);
        }
        #pragma omp taskwait
...
template <typename T>
void matMul_Strassen_P3(T**& matA, T**& matB, T**& matC, int size)
{
    #pragma omp parallel 
    {
        #pragma omp single 
        {
            matMul_Strassen_P3_body(matA,matB,matC,size);
        }
    }
}
